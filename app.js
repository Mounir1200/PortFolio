...
const translations = {
  ...
  "Huit produits personnels et académiques, du besoin initial jusqu’à l’implémentation.": "Eight personal and academic products, from the initial need through implementation.",
  ...
  "HindSight est un système de responsabilisation temporelle pour agents IA : il reconstitue ce qui était vrai, ce que l’agent pouvait connaître et les preuves qu’il a réellement utilisées au moment d’une décision. Sa démonstration télécom synthétique combine verdicts déterministes, mémoire procédurale bitemporelle et recherche vectorielle pour auditer puis corriger une facturation contestée de manière idempotente.": "HindSight is a temporal accountability system for AI agents: it reconstructs what was true, what an agent could know, and which evidence it actually used when making a decision. Its synthetic telecom demo combines deterministic verdicts, bi-temporal procedural memory, and vector retrieval to audit and idempotently remediate a disputed charge.",
  "Données bitemporelles": "Bi-temporal data",
  Technos: "Tech",
...
const translatedAttributes = {
  ...
  "Stack utilisée pour HindSight": "Technology stack used for HindSight",
