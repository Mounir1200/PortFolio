...
const translations = {
  ...
  "Faire évoluer et maintenir en production l’écosystème d’agents conversationnels RAG livré lors du projet de fin d’études.": "Develop features for and maintain in production the conversational RAG agent ecosystem delivered during the final-year project.",
  "Suivre les agents créés, accompagner les enseignants dans l’indexation de leurs supports et la création de leurs agents, puis intervenir sur les incidents en production.": "Track created agents, support teachers as they index their materials and create their agents, then respond to incidents affecting production agents.",
  "Déployer, orchestrer et maintenir des modèles propriétaires (OpenAI, Claude) et open source, avec des interfaces React et Tailwind CSS.": "Deploy, orchestrate and maintain proprietary (OpenAI, Claude) and open-source models, with responsive React and Tailwind CSS interfaces.",
  ...
  "Livrer en production un écosystème d’agents conversationnels RAG utilisé par les enseignants et les étudiants ; permettre aux enseignants d’indexer leurs supports et d’activer ou désactiver leurs agents à la demande.": "Deliver a conversational RAG agent ecosystem to production for teachers and students; enable teachers to index course materials and activate or deactivate their agents on demand.",
  "Développer l’application d’accès aux agents déployés et une interface utilisateur réactive en React à partir de maquettes Figma.": "Develop the access application for deployed agents and a responsive React user interface from Figma mockups.",
  ...
  "Retenir une architecture Data Lakehouse pour exploiter les données CDR, après une étude comparative et une simulation statique sur des données open source.": "Select a Data Lakehouse architecture for CDR data exploitation after a comparative study and static simulation using open-source data.",
  "Intégrer les données CDR et simuler leur stockage en flux continu, jusqu’à trois flux en parallèle.": "Integrate CDR data and simulate continuous-stream storage with up to three parallel streams.",
